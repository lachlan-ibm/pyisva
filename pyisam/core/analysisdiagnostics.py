...
class AnalysisDiagnostics9021(AnalysisDiagnostics9020):
    ...
    def __init__(self, base_url, username, password, docker):
        super(AnalysisDiagnostics9021, self).__init__(base_url, username, password, docker)


class AnalysisDiagnostics9030(AnalysisDiagnostics9021):

    def __init__(self, base_url, username, password, docker):
        super(AnalysisDiagnostics9030, self).__init__(base_url, username, password, docker)


class AnalysisDiagnostics9040(AnalysisDiagnostics9030):

    def __init__(self, base_url, username, password, docker):
        super(AnalysisDiagnostics9040, self).__init__(base_url, username, password, docker)
